...
public class SmackCcsClient {
	...
	public static void main(String[] args) {
		final String userName = "6305380231" + "@gcm.googleapis.com";
		final String password = "AIzaSyAfaESLACPriKKwf9W3hfZ4v95JdBr9gUo";
		...
		String toRegId = "APA91bHyKNDKjrebQ2oJTYymBkNYxTcOPrnRRh7KdycI9zu4ev3lEbIiI1hMsNKPFyyGrD4tgeq6UAdbFBOqH2eDuRYVA7bHCh_k9giM_M4-uTliKW1z3ZTD3k6O_EM9Cb0T50QwIP1v";
		String messageId = ccsClient.getRandomMessageId();
		Map<String, String> payload = new HashMap<String, String>();
		payload.put("type", "generic");
		payload.put("title", "Bokwas");
