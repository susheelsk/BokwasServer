...
public class PostResponse {
	...
	public PostResponse(HashMap<Posts, List<Comments>> map,String accessKey,APIStatus status) {
		super();
		...
		for (Map.Entry<Posts, List<Comments>> entry : map.entrySet()) {
			...
			posts.add(new Post(friendPost.getPostId(), friendPost.getPostTime(), friendPost
					...
					.isBokwasPost(),friendPost.getPostedByName(),friendPost.getAvatarId(),friendPost.getPostUpdatedTime(),friendPost.getFbPicture(),friendPost.getType(),photo_url,postlikes, postCommentList));
		}
